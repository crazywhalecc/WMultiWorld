...
class WoodFlat extends Generator
{
	private $level;
					...
					{ 
						...
						{ 
							...
							{ 
								if ($x < 4 OR $z < 4) 
								{
									$this->chunk1->setBlockId($x, $y, $z, Block::WOOD);
								}
								elseif($x > 4 AND $z > 4)
								{
									$this->chunk1->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x < 4) {
									...
									$this->chunk2->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x < 4 OR $z > 11) {
									...
									$this->chunk3->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($z < 4) {
									...
									$this->chunk4->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11 OR $z < 4) {
									...
									$this->chunk5->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11) {
									...
									$this->chunk6->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11 OR $z > 11) {
									...
									$this->chunk7->setBlockId($x, $y, $z, Block::WOOD);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($z > 11) {
									...
									$this->chunk8->setBlockId($x, $y, $z, Block::WOOD);
					...
					for ($x=0; $x < 16; $x++) { 
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								$this->chunk9->setBlockId($x, $y, $z, Block::WOOD);
