...
class SnowLand extends Generator
{
	private $level;
	...
	public function __construct(array $settings = []){$this->options = $settings;}
					...
					{ 
						...
						{ 
							...
							{ 
								if ($x < 4 OR $z < 4) 
								{
									$this->chunk1->setBlockId($x, $y, $z, Block::BRICKS);
								}
								elseif($x > 4 AND $z > 4)
								{
									$this->chunk1->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x < 4) {
									...
									$this->chunk2->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($x > 4){

									$this->chunk2->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x < 4 OR $z > 11) {
									...
									$this->chunk3->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($x > 4 AND $z <11){

									$this->chunk3->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($z < 4) {
									...
									$this->chunk4->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($z > 4){

									$this->chunk4->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11 OR $z < 4) {
									...
									$this->chunk5->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($x < 11 AND $z > 4){

									$this->chunk5->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11) {
									...
									$this->chunk6->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($x < 11){

									$this->chunk6->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($x > 11 OR $z > 11) {
									...
									$this->chunk7->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($x < 11 AND $z < 11){

									$this->chunk7->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								if ($z > 11) {
									...
									$this->chunk8->setBlockId($x, $y, $z, Block::BRICKS);

								}elseif($z < 11){

									$this->chunk8->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
					...
					for ($x=0; $x < 16; $x++) { 
						...
						for ($z=0; $z < 16; $z++) { 
							...
							for ($y=0; $y < 64; $y++) { 
								...
								$this->chunk9->setBlockId($x, $y, $z, Block::SNOW_BLOCK);
